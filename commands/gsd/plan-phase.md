...
```
TaskCreate({ subject: "Parse arguments and load phase from Mosic", activeForm: "Loading phase" })
TaskCreate({ subject: "Run research (if needed)", activeForm: "Running research" })
